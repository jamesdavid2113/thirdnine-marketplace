      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-nowrap gap-6 overflow-x-auto pb-4">
          {categories.map((category) => (
            ...
            >
              <div className={`relative h-80 w-64 rounded-xl overflow-hidden cursor-pointer transform hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl ${category.bgClass}`}>
